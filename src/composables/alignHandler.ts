...
type AlignLayoutNodeWithMeta = LayoutNodeWithMeta<AlignLayoutNode>;
...
function toLayoutNodes(shapeComposite: ShapeComposite, rootId: string): AlignLayoutNodeWithMeta[] {
