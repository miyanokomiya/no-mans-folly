import { DownstairBlockShape } from "../../../../shapes/polygons/downstairBlock";
...
export const newDownstairBlockSelectedState = defineSingleSelectedHandlerState<
  DownstairBlockShape,
  SimplePolygonHandler,
  never
>(
  (getters) => {
    return {
      getLabel: () => "DownstairBlockSelected",
              ...
              case 0: {
                ...
                if (hitResult) {
                  switch (hitResult.type) {
                    case "c0":
                      return () => {
                        return movingShapeControlState<DownstairBlockShape>({
