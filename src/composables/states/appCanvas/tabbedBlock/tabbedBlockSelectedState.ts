import { TabbedBlockShape } from "../../../../shapes/polygons/tabbedBlock";
...
export const newTabbedBlockSelectedState = defineSingleSelectedHandlerState<
  TabbedBlockShape,
  SimplePolygonHandler,
  never
>(
              ...
              case 0: {
                ...
                if (hitResult) {
                  switch (hitResult.type) {
                    case "c0":
                      return () => {
                        return movingShapeControlState<TabbedBlockShape>({
