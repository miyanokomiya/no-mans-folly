import { UpstairBlockShape } from "../../../../shapes/polygons/upstairBlock";
...
export const newUpstairBlockSelectedState = defineSingleSelectedHandlerState<
  UpstairBlockShape,
  SimplePolygonHandler,
  never
>(
              ...
              case 0: {
                ...
                if (hitResult) {
                  switch (hitResult.type) {
                    case "c0":
                      return () => {
                        return movingShapeControlState<UpstairBlockShape>({
